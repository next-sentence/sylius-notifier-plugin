...
namespace LWC\SyliusNotifierPlugin\Controller;
...
final class GreetingController extends AbstractController
{
    ...
    {
        return $this->render(
            '@LWCSyliusNotifierPlugin/shop/greeting/static.html.twig',
    ...
    {
        return $this->render(
            '@LWCSyliusNotifierPlugin/shop/greeting/dynamic.html.twig',
            ['greeting' => $this->getGreeting($name)],
        );
    }
